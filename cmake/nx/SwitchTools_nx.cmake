...
function(add_nso_target target)
  get_filename_component(target_we ${target} NAME_WE)
  if (CMAKE_RUNTIME_OUTPUT_DIRECTORY)
    add_custom_command(OUTPUT ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${target_we}.nso
            COMMAND ${ELF2NSO} $<TARGET_FILE:${target}> ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${target_we}.nso
            DEPENDS ${target}
            VERBATIM
            )
  else ()
    add_custom_command(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${target_we}.nso
  ...
  if (CMAKE_RUNTIME_OUTPUT_DIRECTORY)
    add_custom_target(${target_we}_nso ALL SOURCES ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${target_we}.nso)
